...
class ChangePass extends Component
{
	...
	cancel()
	{
		axios.get('http://10.226.5.98:81/OM_Comm_Dash/om_comm_backend/check_user.php?user_id='+this.props.user_id)
		.then(res => 
			 {
				if(res.data.ans === "yes")
				{
	...
	handleSubmit(e)
	{
		...
		else
		{
			...
			{
				axios.post('http://10.226.5.98:81/OM_Comm_Dash/om_comm_backend/changepass.php', qs.stringify(obj))
				.then(res => 
				{
